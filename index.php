...
<body>
    ...
    <div class="container-fluid pl-5" style="display:flex; justify-content: space-between">
        <a href="" style="text-decoration:none;">
            <h1 class=" pt-4 pb-2 "><i class="fas fa-address-book"></i><b> Danh bạ</b> </h1>
        </a>
        <div>
            <span style="line-height:100px;font-size:20px;"><i>Xin chào, <?php echo $_SESSION["username"] ?></i> </span>
            <a href="logout.php" style="text-decoration:none; padding-left:20px;padding-right:20px;font-size:20px"><i class="fas fa-door-open"></i><b> Đăng Xuất</b> </a>
        </div>
    </div>
    <!-- form thêm contact-->
                        ...
                        <div class="col-md-2 col-lg-3 nav-contact" style="max-width:300px">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item label-hover">
                                    ...
                                    <i class="far fa-address-card"></i> <b> Danh bạ</b>
                                    </a>
                                </li>
                                <style>
                                    .edit-delete-label {
                                ...
                                foreach ($lsLabel as $key => $value) {
                                    ...
                                    <li class="nav-item ed-label label-hover" ondrop="drop(event)" ondragover="allowDrop(event)" 
                                        ...
                                        <div class="edit-delete-label" >
                                            <svg style="fill:#616161; cursor: pointer;" width="20" height="20" viewBox="0 0 24 24" class="NSy2Hd RTiFqe null"><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M14.06 9.02l.92.92L5.92 19H5v-.92l9.06-9.06M17.66 3c-.25 0-.51.1-.7.29l-1.83 1.83 3.75 3.75 1.83-1.83c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.2-.2-.45-.29-.71-.29zm-3.6 3.19L3 17.25V21h3.75L17.81 9.94l-3.75-3.75z"></path></svg>
                                            <svg style="fill:#616161; cursor: pointer;" width="20" height="20" viewBox="0 0 24 24" class="NSy2Hd RTiFqe null"><path d="M15 4V3H9v1H4v2h1v13c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V6h1V4h-5zm2 15H7V6h10v13z"></path><path d="M9 8h2v9H9zm4 0h2v9h-2z"></path></svg>
                                        </div>
                                    </li>
                                <?php
                                }
